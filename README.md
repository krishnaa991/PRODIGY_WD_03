...
**Live Demo**  
https://krishnaa991.github.io/PRODIGY_WD_03/

## Features
- 2-Player (local) mode
- Play vs Computer (unbeatable Minimax AI as O)
- New game & score tracking (X / O / Draws)
...
## How to run locally
1. Clone:
git clone https://github.com/krishnaa991/PRODIGY_WD_03.git
2. `cd PRODIGY_WD_03`
...
3. Visit `https://krishnaa991.github.io/PRODIGY_WD_03/` after deployment.
